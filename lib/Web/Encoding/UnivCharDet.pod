...
=head1 SYNOPSIS
  ...
  $charset = $det->detect_byte_string;
...
[HTML] HTML Standard
<http://www.whatwg.org/specs/web-apps/current-work/#encoding-sniffing-algorithm>.

The detector is expected to be used as part of the HTML encoding
sniffing algorithm, as defined by the HTML Standard.

[ENCODING] Encoding Standard <http://encoding.spec.whatwg.org/>.
...
May 1, 2013
<http://hg.mozilla.org/mozilla-central/archive/c0e81c0222fc.tar.gz>.

[SWUNIVERSALCHARDET] SuikaWiki:UniversalCharDet
<http://suika.suikawiki.org/~wakaba/wiki/sw/n/UniversalCharDet> (In
Japanese).
