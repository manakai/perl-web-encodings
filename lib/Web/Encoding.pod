...
This function corresponds to the "UTF-8 encode" operation [ENCODING].
...
This function corresponds to the "UTF-8 decode" operation [ENCODING].
...
This function corresponds to the "encode" operation [ENCODING].
...
This module does not support GBK, gb18030, Big5, EUC-JP, ISO-2022-JP,
Shift_JIS, EUC-KR, UTF-16BE, UTF-16LE, x-user-defined, and replacement
yet.
...
[DOM] DOM Standard <https://dom.spec.whatwg.org/>.
